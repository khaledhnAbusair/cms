...
public class SiteController {
	...
	public String viewAddSite(Map<String, Object> model) {
	...
	public String viewSiteManagement(Map<String, Object> model) {
	...
	public String editSiteSetting(@RequestPart(name = SITE_LOGO) MultipartFile siteLogo,
			@RequestParam(name = SITE_ID) Integer siteId, UriComponentsBuilder builder) throws IOException {
	...
	public void downloadSiteLogo(@PathVariable(name = "siteId") Integer siteId, HttpServletResponse response)
			throws IOException {
		response.setContentType("logo/jSpg");
	...
	public String handleCannotBeFindAnySitesException(Exception e, Model model) {
		putErrorMap(e, model, SITE_SETTINGS_JSP);
		return BASE_PAGE;
	}
	...
	public String handlePageNotFoundException(Exception e, Model model) {
		putErrorMap(e, model, EDIT_SITE_JSP);
		return BASE_PAGE;
	}
	...
	public String handleSiteUrlIsAlreadyExistException(Exception e, Model model) {
		putErrorMap(e, model, ADD_SITE_JSP);
		return BASE_PAGE;
	}
