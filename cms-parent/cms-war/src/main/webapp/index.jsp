	...
	<div class="main-wrapper">
					...
					<ul class="nav navbar-right">
						...
						<li class="dropdown current-user"><a data-toggle="dropdown"
							...
							<ul class="dropdown-menu dropdown-dark">
								<li><a href='<c:url value="./changePassword"/>'> Change
										Password </a></li>
		...
		<nav id="pageslide-left" class="pageslide inner">
			...
			<div class="slide-tools">
				<div class="col-xs-6 text-left no-padding"></div>
				<div class="col-xs-6 text-right no-padding">
					<a class="btn btn-sm log-out text-right"
						href='<c:url value="./login"/>'> <i class="fa fa-power-off"></i>
						Log Out
					</a>
				</div>
			</div>
		...
		<div class="main-container inner">
			...
			<div class="cities">
				...
				<h2>I'm khaled Abusair</h2>
				from jordan ,i graduated from facility of information technology
				software engineer department , participated in Microsoft imagine cup
				with an interactive social map application using c# language also
				participated at coding wiz with the same application, and learning
				oracle database, form and report also learned java programming
				language professionally and have a good background in web sites
				design and little about system analysis and projects management ,now
				I'm working Java developer at progressoft corporation.
			</div>
			<!-- end: PAGE -->
		</div>
		<!-- end: MAIN CONTAINER -->
