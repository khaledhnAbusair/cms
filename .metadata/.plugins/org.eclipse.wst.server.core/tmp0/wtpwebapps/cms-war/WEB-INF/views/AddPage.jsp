		...
		<div class="panel panel-white">
			<div class="panel-heading">
				<h4 class="panel-title">
					<span class="text-bold">WELCOME To Add Page</span>
				</h4>
			...
			<div class="panel-body">
				<h2>
					<i class="fa fa-pencil-square"></i> Add Page
				</h2>
				<hr>
				<form action="<c:url value='/dispatch/addPage'/>" method="post">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								<label class="control-label"> Page URI <span
									class="symbol required"></span>
								</label> <input type="text" placeholder="Insert your Page URI"
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea id="seo" name="seo" rows="7" cols="106"></textarea>
							</div>
						</div>
					</div>
