 ...
 * Generated at: 2017-03-01 07:17:28 UTC
...
public final class AddPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<span class=\"text-bold\">WELCOME To Add Page</span>\n");
      out.write("\t\t\t\t</h4>\n");
      ...
      out.write("\t\t\t\t<h2>\n");
      out.write("\t\t\t\t\t<i class=\"fa fa-pencil-square\"></i> Add Page\n");
      out.write("\t\t\t\t</h2>\n");
      out.write("\t\t\t\t<hr>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\"> Page Title <span\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"symbol required\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t</label> <input type=\"text\" placeholder=\"Insert your Page Title\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"pageTitle\" name=\"pageTitle\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\"> Page URI <span\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"symbol required\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t</label> <input type=\"text\" placeholder=\"Insert your Page URI\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"pageUrl\" name=\"pageUrl\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\"> Site <span\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"symbol required\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t</label> <select class=\"form-control\" id=\"siteId\" name=\"site\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"\">Select Parent Name</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<div class=\"col-md-12\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\"> Page SEO <span\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"symbol required\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"summernote\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t<textarea id=\"seo\" name=\"seo\" rows=\"7\" cols=\"106\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"col-md-12\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\"> Page Content <span\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"symbol required\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"summernote\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t<textarea id=\"pageContent\" name=\"pageContent\" rows=\"7\"\n");
      out.write("\t\t\t\t\t\t\t\t\tcols=\"106\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"row\">\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/AddPage.jsp(40,18) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f0.setValue("/dispatch/addPage");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/AddPage.jsp(41,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/AddPage.jsp(73,9) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/views/AddPage.jsp(73,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/AddPage.jsp(120,14) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f1.setValue("./pageManagement");
